...
const SliderProductTab = ({ values, setFieldValue, productData, setSearch }) => {
  ...
  return (
    <>
      ...
      <SliderProduct2 active={active} setActive={setActive} values={values} productData={productData} setSearch={setSearch} setFieldValue={setFieldValue} />
    </>
  );
};
