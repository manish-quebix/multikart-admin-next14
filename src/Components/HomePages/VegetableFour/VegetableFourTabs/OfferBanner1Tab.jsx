              ...
              <div className="shipping-accordion-custom">
                ...
                {active == index && (
                  <div className="rule-edit-form">
                    <FileUploadField paramsProps={{ mime_type: mediaConfig.image.join(",") }} name={`offerBanner1Image${index}`} title="Image" id={`offerBanner1Image${index}`} type="file" values={values} setFieldValue={setFieldValue} showImage={values[`offerBanner1Image${index}`]} helpertext={getHelperText("376x231px")} />
