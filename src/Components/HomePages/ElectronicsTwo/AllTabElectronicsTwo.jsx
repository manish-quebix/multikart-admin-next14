...
import BrandTab from "./ElectronicsTwoTabs/BrandTab";
import CategoryProductTab from "./ElectronicsTwoTabs/CategoryProductTab";
import HomeBannerTab from "./ElectronicsTwoTabs/HomeBannerTab";
import OfferBannerTab from "./ElectronicsTwoTabs/OfferBannerTab";

const AllTabsElectronicsTwo = forwardRef(({ activeTab, values, setFieldValue, apiData = {} }, ref) => {
...
export default AllTabsElectronicsTwo;
