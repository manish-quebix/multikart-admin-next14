...
import BrandTab from "./NurseryHomePageTabs/BrandTab";
import CategoryProductTab from "./NurseryHomePageTabs/CategoryProductTab";
import FeaturedBlogTab from "./NurseryHomePageTabs/FeaturedBlogTab ";
import HomeBannerTab from "./NurseryHomePageTabs/HomeBannerTab";
import ProductListTab from "./NurseryHomePageTabs/ProductListTab";
import SocialMediaTab from "./NurseryHomePageTabs/SocialMediaTab";

const AllTabsNurseryHomePage = forwardRef(({ activeTab, values, setFieldValue, apiData = {} }, ref) => {
...
export default AllTabsNurseryHomePage;
