...
import { FashionSevenSettingTitle } from "@/Data/TabTitleListData";
...
const FashionSevenForm = ({ title,apiData }) => {
  ...
  const { data, isLoading } = useQuery([HomePageAPI], () => request({ url: HomePageAPI, params: { slug: "fashion_seven" } }), {
        ...
        <Col>
          <Card>
            ...
            <Form className="theme-form theme-form-2 mega-form vertical-tabs">
              <Row>
                <Col xl="3" lg="4">
                  <TabTitle activeTab={activeTab} setActiveTab={setActiveTab} titleList={FashionSevenSettingTitle} errors={errors} touched={touched} />
                </Col>
                <AllTabsFashionSeven apiData={apiData} activeTab={activeTab} values={values} setFieldValue={setFieldValue} ref={refRefetch} />
