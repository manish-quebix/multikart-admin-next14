              ...
              <div className="shipping-accordion-custom">
                ...
                {active == index && (
                  <div className="rule-edit-form">
                    ...
                    <CommonRedirect values={values} setFieldValue={setFieldValue} productData={productData} categoryData={categoryData} nameList={{ selectNameKey: `offerRedirectLinkType${index}`, multipleNameKey: `offerRedirectLink${index}` }} setSearch={setSearch} />
