...
import BrandTab from "./ToolsHomePageTabs/BrandTab";
import CategoriesTab from "./ToolsHomePageTabs/CategoriesTab";
import CategoryProductTab from "./ToolsHomePageTabs/CategoryProductTab";
import HomeBannerTab from "./ToolsHomePageTabs/HomeBannerTab";
import ProductList1Tab from "./ToolsHomePageTabs/ProductList1Tab";
import ProductList2Tab from "./ToolsHomePageTabs/ProductList2Tab";
import ServicesTab from "./ToolsHomePageTabs/ServicesTab";

const AllTabsToolsHomePage = forwardRef(({ activeTab, values, setFieldValue, apiData = {} }, ref) => {
...
export default AllTabsToolsHomePage;
