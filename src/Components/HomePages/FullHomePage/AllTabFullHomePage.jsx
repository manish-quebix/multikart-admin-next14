...
import HomeBannerTab from "./FullHomePageTabs/HomeBannerTab";

const AllTabsFullHomePage = forwardRef(({ activeTab, values, setFieldValue, apiData = {} }, ref) => {
...
export default AllTabsFullHomePage;
