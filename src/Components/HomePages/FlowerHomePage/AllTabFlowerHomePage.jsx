...
import BrandTab from "./FlowerHomePageTabs/BrandTab";
import CategoryProductTab from "./FlowerHomePageTabs/CategoryProductTab";
import FeaturedBlogTab from "./FlowerHomePageTabs/FeaturedBlogTab ";
import HomeBannerTab from "./FlowerHomePageTabs/HomeBannerTab";
import OfferBannerTab from "./FlowerHomePageTabs/OfferBannerTab";
import ProductList1Tab from "./FlowerHomePageTabs/ProductList1Tab";
import ProductList2Tab from "./FlowerHomePageTabs/ProductList2Tab";
import ServicesTab from "./FlowerHomePageTabs/ServicesTab";
import SocialMediaTab from "./FlowerHomePageTabs/SocialMediaTab";

const AllTabsFlowerHomePage = forwardRef(({ activeTab, values, setFieldValue, apiData = {} }, ref) => {
...
export default AllTabsFlowerHomePage;
