...
import { FlowerSettingTitle } from "@/Data/TabTitleListData";
...
const FlowerHomePageForm = ({ title, apiData }) => {
  ...
  const { data, isLoading } = useQuery([HomePageAPI], () => request({ url: HomePageAPI, params: { slug: "flower" } }), {
        ...
        <Col>
          <Card>
            ...
            <Form className="theme-form theme-form-2 mega-form vertical-tabs">
              <Row>
                <Col xl="3" lg="4">
                  <TabTitle activeTab={activeTab} setActiveTab={setActiveTab} titleList={FlowerSettingTitle} errors={errors} touched={touched} />
                </Col>
                <AllTabsFlowerHomePage apiData={apiData} activeTab={activeTab} values={values} setFieldValue={setFieldValue} ref={refRefetch} />
