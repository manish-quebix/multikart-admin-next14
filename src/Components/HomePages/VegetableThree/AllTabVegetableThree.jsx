...
import BannerTab from "./VegetableThreeTabs/BannerTab";
import BrandTab from "./VegetableThreeTabs/BrandTab";
import CategoryProductTab from "./VegetableThreeTabs/CategoryProductTab";
import FeaturedBlogTab from "./VegetableThreeTabs/FeaturedBlogTab ";
import HomeBannerTab from "./VegetableThreeTabs/HomeBannerTab";
import ProductListTab from "./VegetableThreeTabs/ProductListTab";
import ServicesTab from "./VegetableThreeTabs/ServicesTab";

const AllTabsVegetableThree = forwardRef(({ activeTab, values, setFieldValue, apiData = {} }, ref) => {
  ...
  return (
    <Col xl="7" lg="8">
      <TabContent activeTab={activeTab}>
        ...
        <TabPane tabId="4">
          <BannerTab values={values} setFieldValue={setFieldValue} categoryData={categoryData} />
        </TabPane>
        <TabPane tabId="5">
...
export default AllTabsVegetableThree;
