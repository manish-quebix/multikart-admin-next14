...
import { PerfumeHomePageSettingTitle } from "@/Data/TabTitleListData";
...
const PerfumeHomePageForm = ({ title, apiData }) => {
  ...
  const { data, isLoading } = useQuery([HomePageAPI], () => request({ url: HomePageAPI, params: { slug: "perfume" } }), {
        ...
        <Col>
          <Card>
            ...
            <Form className="theme-form theme-form-2 mega-form vertical-tabs">
              <Row>
                <Col xl="3" lg="4">
                  <TabTitle activeTab={activeTab} setActiveTab={setActiveTab} titleList={PerfumeHomePageSettingTitle} errors={errors} touched={touched} />
                </Col>
                <AllTabsPerfumeHomePage apiData={apiData} activeTab={activeTab} values={values} setFieldValue={setFieldValue} ref={refRefetch} />
