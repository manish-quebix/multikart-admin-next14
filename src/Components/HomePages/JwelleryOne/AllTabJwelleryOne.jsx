...
import BrandTab from "./JwelleryOneTabs/BrandTab";
import CategoriesTab from "./JwelleryOneTabs/CategoriesTab";
import CategoryProductTab from "./JwelleryOneTabs/CategoryProductTab";
import HomeBannerTab from "./JwelleryOneTabs/HomeBannerTab";
import ProductList1Tab from "./JwelleryOneTabs/ProductList1Tab";
import ServicesTab from "./JwelleryOneTabs/ServicesTab";
import SocialMediaTab from "./JwelleryOneTabs/SocialMediaTab";

const AllTabsJwelleryOne = forwardRef(({ activeTab, values, setFieldValue, apiData = {} }, ref) => {
...
export default AllTabsJwelleryOne;
