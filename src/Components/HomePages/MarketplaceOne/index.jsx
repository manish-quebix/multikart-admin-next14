...
import { MarketplaceOneSettingTitle } from "@/Data/TabTitleListData";
...
const MarketplaceOneForm = ({ title, apiData }) => {
  ...
  const { data, isLoading } = useQuery([HomePageAPI], () => request({ url: HomePageAPI, params: { slug: "marketplace_one" } }), {
        ...
        <Col>
          <Card>
            ...
            <Form className="theme-form theme-form-2 mega-form vertical-tabs">
              <Row>
                <Col xl="3" lg="4">
                  <TabTitle activeTab={activeTab} setActiveTab={setActiveTab} titleList={MarketplaceOneSettingTitle} errors={errors} touched={touched} />
                </Col>
                <AllTabMarketplaceOne apiData={apiData} activeTab={activeTab} values={values} setFieldValue={setFieldValue} ref={refRefetch} />
