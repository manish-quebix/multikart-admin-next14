...
const AllTabsMarketplaceOne = forwardRef(({ activeTab, values, setFieldValue, apiData = {} }, ref) => {
  ...
  return (
    <Col xl="7" lg="8">
      <TabContent activeTab={activeTab}>
        ...
        <TabPane tabId="4">
          <FeaturedBannerTab values={values} setSearch={setSearch} setFieldValue={setFieldValue} categoryData={categoryData} productData={productData} />
        </TabPane>
        <TabPane tabId="5">
