...
import { ChristmasOfferBanner1Title } from "@/Data/TabTitleListData";
...
const OfferBanner1Tab = ({ values, setFieldValue, productData, categoryData, setSearch }) => {
  ...
  return (
    <div className="inside-horizontal-tabs">
      <TabTitle activeTab={activeTab} setActiveTab={setActiveTab} titleList={ChristmasOfferBanner1Title} />
