              ...
              <div className="shipping-accordion-custom">
                ...
                {active == index && (
                  <div className="rule-edit-form">
                    <FileUploadField paramsProps={{ mime_type: index==0? mediaConfig.video.join(","): mediaConfig.image.join(",") }} name={`homeBannerImage${index}`} title={index == 0 ? "Video" : "Image"} id={`homeBannerImage${index}`} type="file" values={values} setFieldValue={setFieldValue} showImage={values[`homeBannerImage${index}`]} helpertext={getHelperText("376x231px")} />
